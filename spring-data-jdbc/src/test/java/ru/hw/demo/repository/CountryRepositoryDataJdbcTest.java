...
@ActiveProfiles("test")
@DataJdbcTest
@TestPropertySource(properties = {"spring.sql.init.data-locations=country-test.sql"})
@DisplayName("Репозиторий на основе Spring Data JDBC по работе с объектом Страна производства")
